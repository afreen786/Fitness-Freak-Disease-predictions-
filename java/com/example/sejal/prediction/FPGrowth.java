...
public class FPGrowth {
    ...
    public FPtree conditional_fptree_constructor(Map<String, Integer> conditionalPatternBase, Map<String, Integer> conditionalItemsMaptoFrequencies, int threshold, Vector<FPtree> conditional_headerTable) {
        //FPTree constructing
        //the null node!
    ...
    public void fptree(File file) throws FileNotFoundException {
       ...
       // System.out.print(itemsMaptoFrequencies);
            System.out.println(fptree.item);
                                for (FPtree child : fptree.children) {  System.out.println(child.item);
                            System.out.println(child.count);
/*for (FPtree child2:child.children)
{
                            System.out.println(child2.item);
                            System.out.print(child2.count);
    ...
    public void preProcessing(File file, Map<String, Integer> itemsMaptoFrequencies, Scanner input, List<String> sortedItemsbyFrequencies, Vector<String> itemstoRemove) throws FileNotFoundException {
        while (input.hasNext()) {
    ...
    public void construct_fpTree(File file, Map<String, Integer> itemsMaptoFrequencies, Scanner input, List<String> sortedItemsbyFrequencies, Vector<String> itemstoRemove) throws FileNotFoundException {
//System.out.println(itemsMaptoFrequencies) ;  
...
//HeaderTable Creation
    ...
    void insert(Vector<String> transactionSortedbyFrequencies, FPtree fptree, Vector<FPtree> headerTable) {
        ...
        if (transactionSortedbyFrequencies.isEmpty()) {
            //System.out.println("hii"+fptree.item);
                       // System.out.println("hii"+fptree.children);

            
                        //System.out.println(fptree.next.item);

            return;
        }
        String itemtoAddtotree = transactionSortedbyFrequencies.firstElement();
       // System.out.println(itemtoAddtotree) ;       
    ...
    public void fpgrowth(FPtree fptree, int threshold, Vector<FPtree> headerTable) {
    ...
    public void insert(Vector<String> pattern_vector, int count_of_pattern, FPtree conditional_fptree, Vector<FPtree> conditional_headerTable) {
